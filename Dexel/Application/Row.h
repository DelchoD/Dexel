...
public:
	...
	* Function for resizing the row
	 * @brief With this function we can resize the row if the
	 * @param columnTotal How many columns to have in the row
	 * @see edit()
	*/
	...
	/**
	* Function for getting the index of a cell
	 * @brief With this function we can search through the table for the desired cell
	 * @return Pointer to the selected cell
	*/
	TableInterface* getTransfer();

	/**
	* Function for associating table with a row
	 * @brief With this function we can associate a table with a specific row
	 * @param rhs The address of the table we want to connect to
	*/
